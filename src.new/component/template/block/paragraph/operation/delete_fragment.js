...
export default function deleteFragment(startNode, startOffset, endNode, endOffset){
	let { rangeApi, nodeApi } = this;

	console.log('执行 deleteFragment');
	console.log('startNode:', startNode, 'startOffset:', startOffset, 'endNode:', endNode, 'endOffset:', endOffset);
